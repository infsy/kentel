...
class ImportExperienceCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('nurun:import:experience')
    ...
    protected function import(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($data as $row) {
            ...
            if (empty($conseiller)) {
                ...
                $conseiller->setDateArrivee(new \DateTime($row['DernierDedateEntree']));
                $conseiller->setExperienceAnnees($row['nbrExpEntreeAnnee']);
                $conseiller->setExperienceMois($row['nbrExpEntreeMois']);
